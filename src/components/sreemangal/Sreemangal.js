...
const Sreemangal = () => {
    ...
    return (
        <div style={{ backgroundImage: `url(${Sreemongol})`, height: '100vh', backgroundSize: '100% 100%', backgroundPosition: 'bottom'}}>
            <div className="row">
                <div className="col-md-4 m-5 p-5">
                <h2 className="display-4 text-warning">SREEMANGAL</h2>
